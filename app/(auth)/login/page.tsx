...
export const metadata: Metadata = { title: 'Sign In — Chaptr' };
  ...
  return (
    <div className="w-full max-w-md space-y-8">
      ...
      <div className="text-center space-y-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-chaptr-text tracking-tight">Welcome back</h1>
          <p className="text-sm text-chaptr-muted mt-1">Sign in to your account</p>
        </div>
      </div>
      ...
      <p className="text-center text-xs text-chaptr-faint">
        By signing in, your data remains encrypted and private.
      </p>
    </div>
  );
}
